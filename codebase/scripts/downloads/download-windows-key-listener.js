 ...
 *
 * Usage:
 *   node scripts/downloads/download-windows-key-listener.js [--force]
 *
 * Options:
...
const VERSION_OVERRIDE = process.env.WINDOWS_KEY_LISTENER_VERSION || "windows-key-listener-v1.0.0";
