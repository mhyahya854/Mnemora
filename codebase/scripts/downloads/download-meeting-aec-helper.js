 ...
 *
 * Usage:
 *   node scripts/downloads/download-meeting-aec-helper.js [--current|--all] [--platform p --arch a] [--force]
 */
...
const VERSION_OVERRIDE = process.env.MEETING_AEC_HELPER_VERSION || "meeting-aec-helper-v1.0.0";
