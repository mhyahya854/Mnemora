 ...
 *
 * Usage:
 *   node scripts/downloads/download-windows-system-audio-helper.js [--force]
 *
 * Options:
...
const VERSION_OVERRIDE =
  process.env.WINDOWS_SYSTEM_AUDIO_HELPER_VERSION || "windows-system-audio-helper-v1.0.0";
