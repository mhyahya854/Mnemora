...
const cSource = path.join(projectRoot, "native", "helpers", "windows", "windows-key-listener.c");
...
async function tryDownload() {
  ...
  const downloadScript = path.join(__dirname, "..", "downloads", "download-windows-key-listener.js");
