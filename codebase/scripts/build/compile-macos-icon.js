#!/usr/bin/env node
// Compiles codebase/renderer/assets/mnemora.icon (Apple Icon Composer bundle) into
// codebase/renderer/assets/Assets.car so macOS 26+ can render Liquid Glass layers.
// The legacy codebase/renderer/assets/icon.icns is maintained separately for macOS <26.
//
...
const ICON_BUNDLE = path.join(__dirname, "..", "..", "renderer", "assets", "mnemora.icon");
const OUTPUT_CAR = path.join(__dirname, "..", "..", "renderer", "assets", "Assets.car");
const APP_ICON_NAME = "mnemora";
