...
const cSource = path.join(projectRoot, "native", "helpers", "windows", "windows-fast-paste.c");
...
async function tryDownload() {
  ...
  const downloadScript = path.join(__dirname, "..", "downloads", "download-windows-fast-paste.js");
