...
const cSource = path.join(projectRoot, "native", "helpers", "windows", "windows-text-monitor.c");
...
async function tryDownload() {
  ...
  const downloadScript = path.join(__dirname, "..", "downloads", "download-text-monitor.js");
