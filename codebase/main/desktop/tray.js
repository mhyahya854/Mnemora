...
const { i18nMain } = require("../infrastructure/runtime/i18nMain");
...
class TrayManager {
  ...
  async loadTrayIcon() {
    ...
    if (platform === "darwin") {
      if (isDevelopment) {
        candidatePaths.push(path.join(__dirname, "..", "..", "renderer", "assets", "iconTemplate@3x.png"));
      } else {
        candidatePaths.push(
          ...
          path.join(__dirname, "..", "..", "renderer", "assets", "iconTemplate@3x.png"),
