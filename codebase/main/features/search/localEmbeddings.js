...
const { getCacheRoot } = require("../transcription/modelDirUtils");
  ...
  _ensureLoaded() {
    ...
    if (!this.isAvailable()) {
      return Promise.reject(
        new Error("Local embedding model not found. Please ensure the local embedding model files are correctly installed.")
      );
    }
