...
const { downsample24kTo16k } = require("./audioUtils");
const { MAX_SPEAKER_COUNT } = require("../../../shared/config/speakerDetection.json");
...
class LiveSpeakerIdentifier {
  ...
  isAvailable() {
    return this._diarizationManager?.isVadModelInstalled() && speakerEmbeddings.isAvailable();
  }
