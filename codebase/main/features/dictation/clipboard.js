...
const { killProcess } = require("../../infrastructure/runtime/process");
...
class ClipboardManager {
  ...
  showAccessibilityDialog(testError) {
    ...
    if (isStuckPermission) {
      dialogMessage = `🔒 Mnemora needs Accessibility permissions, but it looks like you may have old permissions from a previous version.

❗ COMMON ISSUE: After rebuilding or reinstalling, old permissions may be stuck and prevent new ones.
...
4. Click the + button and manually add the new Mnemora app
...
Would you like to open System Settings now?`;
      ...
      dialogMessage = `🔒 Mnemora needs Accessibility permissions to paste text into other applications.
...
4. Add Mnemora to the list and check the box
5. Restart Mnemora
