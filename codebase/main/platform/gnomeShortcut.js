...
const SLOT_CONFIG = {
  dictation: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/mnemora/",
    name: "Mnemora Dictation",
  },
  meeting: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/mnemora-meeting/",
    name: "Mnemora Meeting",
  },
};
