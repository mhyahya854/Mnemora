...
final class AudioTapCapture {
    ...
    private let ioQueue = DispatchQueue(label: "com.mnemora.audio-tap")
    ...
    func start() throws {
        ...
        tapDescription.name = "mnemora-audio-tap"
    ...
    private func createAggregateDevice(tapUID: String) throws {
        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "Mnemora Audio Tap",
            kAudioAggregateDeviceUIDKey: "com.mnemora.audio-tap.\(UUID().uuidString)",
...
func makeError(
    ...
    return NSError(domain: "MnemoraAudioTap", code: Int(status ?? -1), userInfo: userInfo)
}
