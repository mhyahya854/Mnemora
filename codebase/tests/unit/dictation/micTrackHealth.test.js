...
test("resolves false immediately for an ended track", async () => {
  const { waitForTrackReady } = await import("../../../renderer/features/dictation/micTrackHealth.js");
...
test("reacquireIfDead returns the original stream and never retries a healthy track", async () => {
  const { reacquireIfDead } = await import("../../../renderer/features/dictation/micTrackHealth.js");
