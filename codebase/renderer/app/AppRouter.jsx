...
import App from "../features/dictation/App.jsx";
import MeetingNotificationOverlay from "../features/meetings/MeetingNotificationOverlay.tsx";
import TranscriptionPreviewOverlay from "../features/transcription/TranscriptionPreviewOverlay.tsx";
import WindowControls from "./components/WindowControls.tsx";
import { Card, CardContent } from "../shared/ui/card.tsx";
import { useTheme } from "../shared/hooks/useTheme";

const ControlPanel = React.lazy(() => import("./components/ControlPanel.tsx"));
const OnboardingFlow = React.lazy(() => import("../features/onboarding/OnboardingFlow.tsx"));
...
function MainApp() {
  ...
  useEffect(() => {
    if (isControlPanel) {
      ...
      if (!localStorage.getItem("onboardingCompleted")) {
        import("../features/onboarding/OnboardingFlow.tsx").catch(() => {});
      }
    }
  }, [isControlPanel]);
  ...
  const handleOnboardingComplete = (options) => {
    if (options?.openSettings) {
      setPostOnboardingSettingsSection("models");
    }
