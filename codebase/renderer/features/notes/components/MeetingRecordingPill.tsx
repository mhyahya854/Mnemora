...
import { stopRecording, useMeetingRecordingStore } from "../../meetings/meetingRecordingStore";
...
export default function MeetingRecordingPill({
  ...
  const isViewingRecordingNote = activeView === "notes" && activeNoteId === recordingNoteId;
